module DatashiftJourney
  module Collector
    ...
    class FormField < ActiveRecord::Base
      ...
      belongs_to :form, class_name: 'DatashiftJourney::Collector::Form'

      has_many :data_nodes, class_name: 'DatashiftJourney::Collector::DataNode', foreign_key: :form_field_id, dependent: :destroy
      ...
      scope :for_form_and_field, ->(form_name, field_name) {
        page_state = DatashiftJourney::Collector::Form.where('form_name = ?', form_name).first
